...
namespace CapaDatos
{
    public class DDetalle_Ingreso : DbConecction
    {
        //Variables
        ...
        private decimal _Stock_inicial;
        ...
        public decimal Stock_inicial { get => _Stock_inicial; set => _Stock_inicial = value; }
        ...
        public DDetalle_Ingreso(int iddetalle_ingreso, int idingreso, int idarticulo, decimal precio_compra, 
            decimal precio_venta, decimal stock_inicial, decimal stock_actual, DateTime fecha_produccion, 
